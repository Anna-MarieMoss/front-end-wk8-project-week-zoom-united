...
const quotesArr = [
  ...
  //   },
  //   { id: 3, text: "Choose to be optimistic.  It feels better." },
  //   {
  //     id: 4,
  //     text:
  ...
  //   {
  //     id: 7,
  //     text: "Do something today that you future self will thank you for.",
  //   },
  //   { id: 8, text: "Start where you are. Use what you have. Do what you can." },
  //   {
  //     id: 9,
  //     text:
...
function Quotes() {
  const [newQuote, setNewQuote] = useState(quotesArr);
